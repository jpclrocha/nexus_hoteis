...
-- Tablespaces
DROP TABLESPACE TBS_NEXUS_DATA INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
DROP TABLESPACE TBS_NEXUS_INDEX INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
DROP TABLESPACE TBS_NEXUS_IDENTITY_DATA INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
DROP TABLESPACE TBS_NEXUS_IDENTITY_INDEX INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;



CREATE SMALLFILE TABLESPACE TBS_NEXUS_DATA 
    DATAFILE 
        'DF_TBS_NEXUS_DATA' SIZE 200 M REUSE AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED 
    LOGGING 
    ONLINE 
...
CREATE SMALLFILE TABLESPACE TBS_NEXUS_IDENTITY_DATA 
    DATAFILE 
        'DF_TBS_NEXUS_IDENTITY_DATA' SIZE 25 M REUSE AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED 
    LOGGING 
    ONLINE 
    EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1 M
    SEGMENT SPACE MANAGEMENT AUTO
...
CREATE SMALLFILE TABLESPACE TBS_NEXUS_IDENTITY_INDEX 
    DATAFILE 
        'DF_TBS_NEXUS_IDENTITY_INDEX' SIZE 25 M REUSE AUTOEXTEND ON NEXT 10 M MAXSIZE UNLIMITED 
    LOGGING 
    ONLINE 
    EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1 M
    SEGMENT SPACE MANAGEMENT AUTO
...
CREATE SMALLFILE TABLESPACE TBS_NEXUS_INDEX 
    DATAFILE 
        'DF_TBS_NEXUS_INDEX' SIZE 200 M REUSE AUTOEXTEND ON NEXT 50 M MAXSIZE UNLIMITED 
    LOGGING 
    ONLINE 
    EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1 M
    SEGMENT SPACE MANAGEMENT AUTO
